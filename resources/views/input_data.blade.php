...
@section('body')
    <form action="/tambah" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" name="nama" required="required" class="form-control"  id="staticName" placeholder="masukkan nama ...">
            @if($errors->has('nama'))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" name="umur" required="required" class="form-control"  id="staticAge" placeholder="masukkan umur ...">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" name="perusahaan" required="required" class="form-control"  id="staticName" placeholder="masukkan nama perusahaan ...">
            ...
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        <input id="tgl_mulai" placeholder="masukkan tanggal mulai" type="text" class="form-control datepicker" name="tgl_mulai" required>
                    </div>
